...
from mask_former import (
    ...
    BoundaryMaskFormerSemanticDatasetMapper,
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic":
            # mapper = MaskFormerSemanticDatasetMapper(cfg, True) 原本的是这个 我加了boundary
            mapper = BoundaryMaskFormerSemanticDatasetMapper(cfg, True)
